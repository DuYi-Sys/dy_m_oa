...
public class StudentQuestionController {
	...
	@RequestMapping(path="/c/s/question",method=RequestMethod.POST, produces="application/json",consumes="application/json")
	...
	@RequestMapping(path="/c/question",method=RequestMethod.GET, produces="application/json")
	...
	@RequestMapping(path="/c/question/{id}",method=RequestMethod.GET, produces="application/json")
