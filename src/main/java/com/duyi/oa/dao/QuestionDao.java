...
public interface QuestionDao {
    ...
    @Select("select count(*) from question_bank where uploadId = #{uploadId} and topic_id = #{topicId} and status>#{status} and update_time > #{strDate} and LOCATE(#{keyWord},question_body) > 0")
